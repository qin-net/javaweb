 ...
 *
 * 功能详述：
 *   对所有 /api/* 路径的请求统一设置 CORS 响应头，允许前端地址
 *   http://localhost:5173 的跨域访问（携带 Cookie 凭证）。
 *   支持的 HTTP 方法包括 GET、POST、PUT、DELETE、OPTIONS。
...
public class CorsFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        resp.setHeader("Access-Control-Allow-Headers", "Content-Type, Authorization, Cookie");
